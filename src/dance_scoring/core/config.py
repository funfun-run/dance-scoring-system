...
SCORE_TOLERANCE = 3.0
SCORE_PENALTY_SMALL = 2.0     # 每度扣分（≤10°），原1.8
SCORE_PENALTY_LARGE = 3.0     # 每度扣分（>10°），原3.0
SCORE_PENALTY_THRESHOLD = 10.0
COVERAGE_FLOOR = 0.93         # 关节不可见时分数下限
MOTION_FLOOR = 0.15           # 动作幅度不足时分数下限
